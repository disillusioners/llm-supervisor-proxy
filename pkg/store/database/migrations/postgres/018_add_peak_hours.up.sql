...
-- peak_hour_enabled: Whether peak hour switching is enabled (boolean for PostgreSQL)
...
ALTER TABLE models ADD COLUMN peak_hour_enabled BOOLEAN NOT NULL DEFAULT FALSE;
